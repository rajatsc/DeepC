...
print("Examples in training set: " + str(train.X.rows))
print("Examples in test set: " + str(test.X.rows))
...
train_image_classifier(m, train, batch, iters, rate*.1, momentum, decay)
print("done")
print
